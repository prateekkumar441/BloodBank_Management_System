...
public class MiniStatement extends JFrame{
    MiniStatement(String pinnumber){
       ...
       bank.setBounds(130,20,130,20);
       add(bank);
      
      ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/sb.jpg"));
      Image i2=i1.getImage().getScaledInstance(50,50,Image.SCALE_DEFAULT);
      ImageIcon i3=new ImageIcon(i2);
      JLabel image=new JLabel(i3);//jlabel use for set the image
      image.setBounds(20,5,160,50);//set image in the left corner of the frame
      add(image);
